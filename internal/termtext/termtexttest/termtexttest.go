...
// value through reflection, and an assertion that no control character or
// malformed UTF-8 survived.
//
...
// sequence, CR, LF, TAB and DEL — plus printable multi-byte text that must
// survive it all.
...
// character (below 0x20, 0x7f, or 0x80–0x9f) or malformed UTF-8, naming the
// field path that carried it. label names the value in the failure.
//
